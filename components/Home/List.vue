        ...
        <div class="grid grid-cols-12 gap-2">
            <div class="col-span-12 md:col-span-6 lg:col-span-3">
                <div class="bg-surface-0 dark:bg-surface-900 shadow p-4 rounded-border">
                    <div class="flex justify-between mb-4">
                        <div>
                            <span class="block text-surface-500 dark:text-surface-300 font-medium mb-4">{{ monthHeader }}</span>
                            <div class="text-surface-900 dark:text-surface-0 font-medium !text-xl">{{ $usd(month) }}</div>
                        </div>
            ...
            <div class="col-span-12 md:col-span-6 lg:col-span-3">
                <div class="bg-surface-0 dark:bg-surface-900 shadow p-4 rounded-border">
                    <div class="flex justify-between mb-4">
                        <div>
                            <span class="block text-surface-500 dark:text-surface-300 font-medium mb-4">{{ yearHeader }}</span>
                            <div class="text-surface-900 dark:text-surface-0 font-medium !text-xl">{{ $usd(year) }}</div>
                        </div>
            ...
            <div class="col-span-12 md:col-span-6 lg:col-span-3">
                <div class="bg-surface-0 dark:bg-surface-900 shadow p-4 rounded-border">
                    <div class="flex justify-between mb-4">
                        <div>
                            <span class="block text-surface-500 dark:text-surface-300 font-medium mb-4">{{ averageHeader }}</span>
                            <div class="text-surface-900 dark:text-surface-0 font-medium !text-xl">{{ $usd(average) }}</div>
                        </div>
            ...
            <div class="col-span-12 md:col-span-6 lg:col-span-3">
                <div class="bg-surface-0 dark:bg-surface-900 shadow p-4 rounded-border">
                    <div class="flex justify-between mb-4">
                        <div>
                            <span class="block text-surface-500 dark:text-surface-300 font-medium mb-4">{{ forecastHeader }}</span>
                            <div class="text-surface-900 dark:text-surface-0 font-medium !text-xl">{{ $usd(forecast) }}</div>
                        </div>
...
<script setup lang="ts">
    ...
    const {month,year,average,forecast,monthHeader,yearHeader,averageHeader,forecastHeader} = props;
