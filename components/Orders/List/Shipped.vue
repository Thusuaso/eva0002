<template>
    <DataTable 
        ...
        :globalFilterFields="['YuklemeTarihi','SiparisNo', 'FirmaAdi', 'UrunAdi', 'UrunUretimAciklama', 'En', 'Boy', 'Kenar','UrunFirmaAdi']"
        filterDisplay="row"
        paginator :rows="30"
    ...
    >
        ...
        <Column field="YuklemeTarihi" header="O. Date" style="min-width: 80px" :showClearButton="false" :showFilterMenu="false" :showFilterOperator="false">
